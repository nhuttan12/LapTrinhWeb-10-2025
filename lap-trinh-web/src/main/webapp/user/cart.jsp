                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <img src="${pageContext.request.contextPath}/user/images/cloth_1.jpg" alt="Image" class="img-fluid">
                                </td>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <img src="${pageContext.request.contextPath}/user/images/cloth_2.jpg" alt="Image" class="img-fluid">
                                </td>
                                <td class="product-name">

...
<html lang="vi">
<head>
    <title>Shoppers &mdash; Giỏ Hàng</title>
    <meta charset="utf-8">
            ...
            <form class="col-md-12 mb-5" method="post" action="${pageContext.request.contextPath}/cart">
                ...
                <div class="site-blocks-table">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th class="product-buy">Mua Ngay</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:if test="${cart != null && cart.cartDetails != null}">
                            <c:forEach var="detail" items="${cart.cartDetails}">
                                <tr>
                                    ...
                                    <td>
                                        <fmt:formatNumber value="${detail.product.price}" type="number" groupingUsed="true"/> vnđ
                                    </td>
                                    ...
                                    <td>
                                        <div class="input-group mb-3" style="max-width: 120px;">
                                            ...
                                            <input type="text" name="quantity_${detail.product.id}" class="form-control text-center" value="${detail.quantity}" min="1">
                                    ...
                                    <td>
                                        <fmt:formatNumber value="${detail.product.price * detail.quantity}" type="number" groupingUsed="true"/> vnđ
                                    </td>
                                    ...
                                    <td>
                                        <form action="${pageContext.request.contextPath}/checkout-single" method="post">
                ...
                <div class="row mb-5">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <button type="submit" class="btn btn-primary btn-block">Cập Nhật Giỏ Hàng</button>
                    </div>
                    <div class="col-md-6">
                        <a href="${pageContext.request.contextPath}/product-list" class="btn btn-outline-primary btn-block">Tiếp Tục Mua Sắm</a>
                    </div>
                </div>
            </form>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 text-right">
                                    <strong class="text-black"><fmt:formatNumber value="${subtotal}" type="number" groupingUsed="true"/> vnđ</strong>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="${pageContext.request.contextPath}/checkout" class="btn btn-primary btn-lg py-3 btn-block">Tiến Hành Thanh Toán</a>
                                </div>
                            </div>

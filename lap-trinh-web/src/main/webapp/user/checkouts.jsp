...
<div class="site-wrap">
    ...
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="${pageContext.request.contextPath}/home">Home</a> <span class="mx-2 mb-0">/</span> <a
                        href="${pageContext.request.contextPath}/cart">Cart</a> <span class="mx-2 mb-0">/</span> <strong
                            ...
                            <div class="p-3 p-lg-5 border">
                                <table class="table site-block-order-table mb-5">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-black">$${order.subtotal}</td>
                                    </tr>
                                    <tr>
                                        <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                                        <td class="text-black font-weight-bold"><strong>$${order.totalPrice}</strong></td>
                                    </tr>
                                    </tbody>
                                ...
                                <form action="${pageContext.request.contextPath}/payment" method="post">
                                    ...
                                    <!-- orderId & amount phải được backend set trước -->
                                    ...
                                    <div class="border p-3 mb-3">
                                        <label>
                                            <input type="radio" name="method" value="momo_test">
                                            Momo Test Payment
                                        </label>
                                    </div>

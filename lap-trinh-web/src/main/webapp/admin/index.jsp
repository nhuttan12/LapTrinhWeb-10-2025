...
<head>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/admin/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/admin/vendors/ti-icons/css/themify-icons.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/admin/js/select.dataTables.min.css">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo mr-5" href="index.jsp"><img
                    src="${pageContext.request.contextPath}/admin/images/logo.svg" class="mr-2"
                    alt="logo"/></a>
            ...
            <ul class="navbar-nav navbar-nav-right">
                ...
                <li class="nav-item nav-profile dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                        <img src="${pageContext.request.contextPath}/admin/images/faces/face28.jpg" alt="profile"/>
                    </a>
            ...
            <div class="tab-content" id="setting-content">
                ...
                <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                    ...
                    <ul class="chat-list">
                        ...
                        <li class="list">
                            <div class="profile"><img
                                    src="${pageContext.request.contextPath}/admin/images/faces/face2.jpg"
                                    alt="image"><span
                        ...
                        <li class="list">
                            <div class="profile"><img
                                    src="${pageContext.request.contextPath}/admin/images/faces/face3.jpg"
                                    alt="image"><span
                                    class="online"></span></div>
                            <div class="info">
                                <p>Daniel Russell</p>
                        ...
                        <li class="list">
                            <div class="profile"><img
                                    src="${pageContext.request.contextPath}/admin/images/faces/face4.jpg"
                                    alt="image"><span
                                    class="offline"></span></div>
                            <div class="info">
                        ...
                        <li class="list">
                            <div class="profile"><img
                                    src="${pageContext.request.contextPath}/admin/images/faces/face5.jpg"
                                    alt="image"><span
                                    class="online"></span></div>
                            <div class="info">
                        ...
                        <li class="list">
                            <div class="profile"><img
                                    src="${pageContext.request.contextPath}/admin/images/faces/face6.jpg"
                                    alt="image"><span
                                    class="online"></span></div>
                            <div class="info">
                                <p>Sarah Graves</p>
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card tale-bg">
                            <div class="card-people mt-auto">
                                <img src="${pageContext.request.contextPath}/admin/images/dashboard/people.svg"
                                     alt="people">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="icon-data-list">
                                    <li>
                                        <div class="d-flex">
                                            <img src="${pageContext.request.contextPath}/admin/images/faces/face1.jpg"
                                                 alt="user">
                                            <div>
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            <img src="${pageContext.request.contextPath}/admin/images/faces/face2.jpg"
                                                 alt="user">
                                            <div>
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            <img src="${pageContext.request.contextPath}/admin/images/faces/face3.jpg"
                                                 alt="user">
                                            <div>
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            <img src="${pageContext.request.contextPath}/admin/images/faces/face4.jpg"
                                                 alt="user">
                                            <div>
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            <img src="${pageContext.request.contextPath}/admin/images/faces/face5.jpg"
                                                 alt="user">
                                            <div>
...
<script src="${pageContext.request.contextPath}/admin/vendors/datatables.net/jquery.dataTables.js"></script>
<script src="${pageContext.request.contextPath}/admin/vendors/datatables.net-bs4/dataTables.bootstrap4.js"></script>
<script src="${pageContext.request.contextPath}/admin/js/dataTables.select.min.js"></script>
...
<script src="${pageContext.request.contextPath}/admin/js/Chart.roundedBarCharts.js"></script>
<script>
  // Xóa active mặc định
